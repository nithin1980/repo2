...
public class ProcessingBlock13 extends ProcessModelAbstract {
	...
	public ProcessingBlock13(CacheService cacheService) {
		super();
	...
	public void processNow() {
		...
		try {
			...
			System.out.println("Model 13,PE so far:"+peInfo.get(0)+","+peInfo.get(1)+","+peInfo.get(2));
			System.out.println("Model 13,CE so far:"+ceInfo.get(0)+","+ceInfo.get(1)+","+ceInfo.get(2));
			System.out.println("Model 13,Total:"+(Double.valueOf(peInfo.get(2))+Double.valueOf(ceInfo.get(2))));
		} finally {
