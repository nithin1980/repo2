...
public class ProcessingBlock13 extends ProcessModelAbstract {
	...
	public void processNow() {
		...
		try {
			...
			System.out.println("Model 13,PE so far:"+peInfo.get(0)+","+peInfo.get(1)+","+peInfo.get(2)+","+peInfo.get(3));
			System.out.println("Model 13,CE so far:"+ceInfo.get(0)+","+ceInfo.get(1)+","+ceInfo.get(2)+","+ceInfo.get(3));
			...
			System.out.println("Model 13,Total,"+total+",Percen,"+percost);
		} finally {
