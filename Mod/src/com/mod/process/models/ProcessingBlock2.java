...
//						}
						...
						if(currentProfit<=newPosition.getBracketLowHigherValue().getValue()){
							if(newPosition.getReversePositionOppurtunityCount()>=350){
								newPosition.setSell(Double.valueOf(values.get(3)));
								newPosition.setSellRecord(i);
								...
								newPosition.setReversePositionOppurtunityCount(newPosition.getReversePositionOppurtunityCount()+1);
								
							}
						}else{
							newPosition.setReversePositionOppurtunityCount(0);
						}
